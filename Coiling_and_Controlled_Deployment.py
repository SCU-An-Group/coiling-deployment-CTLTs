...
mdb.models['Model-1'].rootAssembly.Set(edges=
    ...
    114.5, 90.0), ), ((245.0, 46.5, 90.0), ), ), name='plane_symmetry')

mdb.models['Model-1'].rootAssembly.Set(edges=
    mdb.models['Model-1'].rootAssembly.instances['DCB-1'].edges.findAt(
    ((995.0, 80.5, 30), )), name='line')
...
mdb.models['Model-1'].rootAssembly.Surface(name='plate1_bottom', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['plate1-1'].faces)
mdb.models['Model-1'].rootAssembly.Surface(name='plate2_top', side2Faces=
    mdb.models['Model-1'].rootAssembly.instances['plate2-1'].faces)
mdb.models['Model-1'].rootAssembly.Surface(name='plate3_bottom', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['plate3-1'].faces)
mdb.models['Model-1'].rootAssembly.Surface(name='Roller_surface', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['C_Roller-1'].faces)
mdb.models['Model-1'].rootAssembly.Surface(name='shafts_surface', side1Faces=
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-2'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-3'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-4'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-5'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-6'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-7'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-8'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-9'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-10'].faces+\
    mdb.models['Model-1'].rootAssembly.instances['Cst_shaft-1-rad-11'].faces)
...
mdb.models['Model-1'].ExplicitDynamicsStep(description='Coiling-deformation', 
    ...
    2.0)
mdb.models['Model-1'].ExplicitDynamicsStep(description='unfold_slowly', 
    improvedDtMethod=ON, name='slow_unfold', previous='Coiling', timePeriod=
    2.0)
...
jobName = 'halfDCB_coiling_and_slow_unfold'
mdb.Job(model='Model-1', name=jobName, explicitPrecision=DOUBLE_PLUS_PACK, numCpus=32, numDomains=32)
